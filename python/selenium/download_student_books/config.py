...
# Credentials for signing in IPRBOOKSHOP.ru site. Bad design, dont keep them like this
IPRBOOK_LOGIN = "jhon.smith@gmail.com"
IPRBOOK_PASSWORD = "SuP3R_S3cR3T"  # FIXME: dont keep passwords in a raw text
