...
import hex.arch.topologyinventory.framework.adapter.out.h2.data.ModelData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.VendorData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.IPData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.RouterData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.LocationData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.NetworkData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.RouterTypeData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.SwitchData;
import hex.arch.topologyinventory.framework.adapter.out.h2.data.SwitchTypeData;
